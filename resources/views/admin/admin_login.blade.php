        ...
        @endif                
            <form id="loginform" class="form-vertical" method="post" action="{{url('admin')}}">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="text" name="email" required placeholder="Email" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="{{ route('password.request') }}" class="flip-link btn btn-info" id="to-recover">Lost password?</a></span>
